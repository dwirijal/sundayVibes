    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-10 bg-card border border-border rounded-3xl p-6 shadow-sm">
        ...
        <div className="w-full bg-muted rounded-full h-2.5 overflow-hidden">
          <div
            className="bg-primary h-full transition-transform duration-300 ease-in-out rounded-full origin-left w-full"
      ...
      <form onSubmit={handleSubmit} className="bg-card border border-border rounded-[2.5rem] p-8 md:p-10 shadow-md">
              ...
              {SERVICES.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-start gap-4 p-4 rounded-2xl border text-left transition-[border-color,background-color,box-shadow] ${
                      isSelected
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div>
                <label htmlFor="booking-date" className="block text-sm font-bold text-foreground mb-2">
              ...
              <div>
                <label htmlFor="booking-budget" className="block text-sm font-bold text-foreground mb-2">
                  Estimasi Budget
                </label>
                <select
                  id="booking-budget"
              ...
              <div>
                <label htmlFor="booking-description" className="block text-sm font-bold text-foreground mb-2">
        ...
        {step === 3 && (
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div>
                <label htmlFor="booking-name" className="block text-sm font-bold text-foreground mb-2">
                  Nama Lengkap
                </label>
                <input
                  id="booking-name"
              ...
              <div>
                <label htmlFor="booking-contact" className="block text-sm font-bold text-foreground mb-2">
                  Email / No. WhatsApp
                </label>
                <input
                  id="booking-contact"
              ...
              <div>
                <label htmlFor="booking-notes" className="block text-sm font-bold text-foreground mb-2">
