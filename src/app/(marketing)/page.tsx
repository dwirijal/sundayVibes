      ...
      <main className="flex-1 flex items-center pt-20 relative">
        ...
        <div className="container mx-auto px-6 py-12 lg:py-24 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative flex items-center justify-center h-[500px] lg:h-[600px] w-full">
            ...
            <Link href="/layanan/digital" className="absolute top-[10%] right-[10%] z-30 bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-xl border border-stone-100 dark:border-stone-700 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 hover:scale-105 transition-transform cursor-pointer block">
            ...
            <Link href="/foto" className="absolute bottom-[20%] left-[5%] z-30 bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-xl border border-stone-100 dark:border-stone-700 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 hover:scale-105 transition-transform cursor-pointer block">
              <div className="flex items-center gap-3">
            ...
            <Link href="/layanan/coding" className="absolute top-[60%] right-[-5%] z-30 bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-xl border border-stone-100 dark:border-stone-700 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-700 hover:scale-105 transition-transform cursor-pointer hidden sm:block">
              <div className="flex items-center gap-3">
